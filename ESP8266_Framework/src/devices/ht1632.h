#ifndef _HT1632_
  #define _HT1632_
 #ifndef DISPLAY_HT1632
	#define DISPLAY_HT1632 DISABLE
 #endif
 #if DISPLAY_HT1632 == ENABLE
 
	#define HT1632_DISPLAY	0x03	
	#define HT1632_EFFECT	0x300
	#define HT1632_BRIGHT	0x301
	#define HT1632_FADEUP	0x302
	#define HT1632_FADEDOWN	0x303
	#define HT1632_SCROLL	0x304
    #define HT1632_CLOCK	0x305
...
#define HT1632_DATA     D2    // Data pin (pin 7)
#define HT1632_WRCLK    D1    // Write clock pin (pin 5)
#define HT1632_CS       D0    // Chip Select (1, 2, 3, or 4)
